...
import { BookOpen, Code2, ArrowRight, FlaskConical } from 'lucide-react';
            ...
            <header className="mb-12 text-center w-full px-4">
                ...
                >
                    ...
                    <h1 className="text-4xl font-extrabold tracking-tight text-white">
                        JAVA PROGRAMMING <span className="gradient-text">LAB</span>
                    </h1>
                </motion.div>
                <p className="text-slate-400 text-lg max-w-2xl mx-auto">
                    Welcome to the Virtual Java Programming Laboratory. Select an experiment below to start your interactive simulation.
                </p>
            </header>
