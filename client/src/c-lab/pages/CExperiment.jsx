...
const CExperiment = () => {
    ...
    const experiment = cExperiments.find(e => e.id === parseInt(id));

    const [activeTab, setActiveTab] = useState('theory');

    useEffect(() => {
        if (!experiment) navigate('/c-lab');
    }, [experiment, navigate]);
            ...
            <div className="h-14 w-full shrink-0 border-b border-white/5 flex items-center justify-between px-4 sm:px-6 bg-[#0f172a] z-30">
                <div className="flex items-center gap-2 sm:gap-4 overflow-hidden">
                    ...
                    <h2 className="font-bold text-slate-200 uppercase tracking-tight text-xs sm:text-sm truncate">
                        C Lab: Experiment {experiment.id} - {experiment.title}
                    </h2>
                </div>
            </div>
                ...
                <div className="flex-1 w-full relative overflow-hidden bg-[#020617] min-h-0">
                    <AnimatePresence mode="wait">
                        {activeTab === 'theory' && (
                            ...
                            >
                                <div className="max-w-4xl mx-auto space-y-6">
                                    <ExperimentSection title="Aim / Objective" icon={Target} color="blue">
                        ...
                        {activeTab === 'procedure' && (
                            ...
                            >
                                <div className="max-w-4xl mx-auto space-y-6">
                                    ...
                                    <ExperimentSection title="Expected Result" icon={CheckCircle2} color="blue">
                        ...
                        {activeTab === 'editor' && (
                            ...
                            >
                                <CCompiler defaultCode={experiment.defaultCode} />
                            </motion.div>
                        )}
                    </AnimatePresence>
                </div>
